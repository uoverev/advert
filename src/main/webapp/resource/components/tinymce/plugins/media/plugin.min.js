...
tinymce.PluginManager.add('media', function(editor, url) {
	var urlPatterns = [
		...
		{regex: /v\.youku\.com\/v_show\/id_([\w\-=]+)\.html/, type: 'iframe', w: 425, h: 350, url: '//player.youku.com/embed/$1'},
		{regex: /tudou\.com\/(listplay|albumplay)\/([\w\-=]+)\/([\w\-=]+)\.html/, type: 'iframe', w: 425, h: 350, url: '//www.tudou.com/programs/view/html5embed.action?type=0&code=$3&lcode='},
		{regex: /tudou\.com\/programs\/view\/([\w\-=]+)\//, type: 'iframe', w: 425, h: 350, url: '//www.tudou.com/programs/view/html5embed.action?type=0&code=$1&lcode='},
		{regex: /56\.com\/([\w\-=]+)\/v_([\w\-=]+)\.html/, type: 'iframe', w: 425, h: 350, url: '//www.56.com/iframe/$2"'},
		{regex: /v\.ku6\.com\/.+\/([\w\-=._]+)\.html.*$/, type: 'iframe', w: 425, h: 350, url: '//player.ku6.com/refer/$1/v.swf'}
	];

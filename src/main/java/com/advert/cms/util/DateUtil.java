...
//			da = df.parse(date);
	...
	public static String secToTime(int sec){
        ...
        if (sec <= 0)
            ...
            if (minute < 60) {
                second = sec % 60;
                timeStr = StringUtil.unitFormat(minute) + ":" + StringUtil.unitFormat(second);
            } else {
                hour = minute / 60;
                if (hour > 99)
                    return "99:59:59";
                ...
                timeStr = StringUtil.unitFormat(hour) + ":" + StringUtil.unitFormat(minute) + ":" + StringUtil.unitFormat(second);
            }  
        }  
        return timeStr;  
	}
